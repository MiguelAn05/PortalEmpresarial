  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg">
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#D6E0F0]">
          <div>
            <h2 className="font-bold text-[#0D2B5E] text-lg">PQRS #{pqrs.id}</h2>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-[#F0F4FA] border-b border-[#D6E0F0]">
                {['#', 'Tipo', 'Cliente', 'Área', 'Prioridad', 'SLA', 'Estado', ''].map(h => (
            ...
            <tbody>
              {pqrsList.map((pqrs) => (
                ...
                >
                  <td className="px-4 py-3 text-xs text-[#6B7EA8] font-mono">#{pqrs.id}</td>
